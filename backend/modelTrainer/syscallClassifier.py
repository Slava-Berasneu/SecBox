...
class SyscallClassifier(ModelTrainer):
    ...
    def saveModel(self, file_name):
        ...
        models["categories"]["syscall_malware_analyzer"].append(new_model)
...
def testExampleModel():
    cwd = os.getcwd()
    with open(cwd+'/'+'backend/modelTrainer/models/frequency_syscall_classifier_bayes.pkl', 'rb') as file:
    #with open(cwd+'/'+'backend/modelTrainer/models/sequence_syscall_classifier_bayes.pkl', 'rb') as file:
    #with open(cwd+'/'+'backend/modelTrainer/models/frequency_syscall_classifier_tree.pkl', 'rb') as file:
    #with open(cwd+'/'+'backend/modelTrainer/models/sequence_syscall_classifier_tree.pkl', 'rb') as file:
